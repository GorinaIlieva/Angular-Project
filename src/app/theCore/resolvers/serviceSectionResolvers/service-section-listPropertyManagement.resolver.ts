...
export class ServicePropertyManagementResolver implements Resolve<ServiceEachSection[]>{

    constructor(private serviceSectionService: ServiceSectionService){ }

    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot){
        return this.serviceSectionService.getPropertyManagementServiceList()
    }
}